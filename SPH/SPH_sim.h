...
#include <driver_types.h>	
	...
	// Vector params
	#define SPH_VOLMIN			7	//volumn of the container
	#define SPH_VOLMAX			8
	#define SPH_INITMIN			9	//initial shape of particles
	...
	public:
		...
		void setPoint(Fluid* a);
		
		// Smoothed Particle Hydrodynamics
		void SPH_Setup ();
		void SPH_Test ( int n, int nmax );
		void SPH_DrawDomain ();
		void SPH_ComputeKernels ();
		void SPH_ComputePressure ();			// O(n^2)

		void SPH_ComputeForce();				// O(n^2)

		void SPH_DrawTriangles(float* view_mat);
